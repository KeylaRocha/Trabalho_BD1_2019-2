...
<body>
  ...
  <main>
    ...
    <div class="ui segment">
      <h4 class="ui header">Edição de Clientes (Pessoa Jurídica)</h4>
    </div>
	<form action="http://localhost/ferramenta_bd1-master/index.php/Edicao/PessoaJuridica/<?php if(isset($dados)) echo $dados["id"]; ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data" class="ui form 1">
    <div class="ui form inverted segment">
	  ...
	  <div class="two fields">
		<div class="field">
          <label>CNPJ</label>
          <input placeholder="CPF/CNPJ do Cliente" name="cliente" id="cliente" type="text" <?php if(isset($dados['cliente'])) echo 'value="'.$dados['cliente'].'"';?>>
        </div>
		<div class="field">
          <label>Razão Social</label>
          <input placeholder="Razão Social" name="razaosoc" id="razaosoc" type="text" <?php if(isset($dados['razaosoc'])) echo 'value="'.$dados['razaosoc'].'"';?>>
        </div>
	  </div>
	
	<div class="field">
	  <label>Nome do Representante</label>
	  <input placeholder="Representante" name="repr" id="repr" type="text" <?php if(isset($dados['repr'])) echo 'value="'.$dados['repr'].'"';?>>
	</div>
