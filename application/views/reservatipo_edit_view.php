...
<body>
  ...
  <main>
    ...
    <div class="ui segment">
      <h4 class="ui header">Edição de Tipos na Reserva</h4>
    </div>
	<form action="http://localhost/ferramenta_bd1-master/index.php/Edicao/ReservaTipo/<?php if(isset($dados)) echo $dados["id"]; ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data" class="ui form 1">
    <div class="ui form inverted segment">
		<div class="field">
          <label>Reserva</label>
          <input placeholder="Reserva" disabled="True" name="reserva" id="reserav" type="text" <?php if(isset($dados)) echo 'value="'.$dados['reserva'].'"';?>>
        </div>
