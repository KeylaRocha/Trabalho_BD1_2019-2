...
<body>
  ...
  <main>
	...
	<div class="ui top attached inverted header">RESERVAS</div>
	...
	<?php if(isset($reservas)){
			...
			foreach($reservas as $r){
				echo "<tr>";
				echo "<td>".$r[0]->getIdReserva()."</td>";
				echo "<td>".$r[0]->getDataRetirada()."</td>";
				echo "<td>".$r[0]->getHora()."</td>";
				echo "<td>".$r[0]->getDataDevolucao()."</td>";
				if(method_exists($r[1],"getCPF"))
					echo "<td>".$r[1]->getCPF()."</td>";
				else
					echo "<td>".$r[1]->getCNPJ()."</td>";
				echo '<td>
