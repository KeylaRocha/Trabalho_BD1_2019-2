...
<body>
  ...
  <main>
    ...
    <div class="ui segment">
      <h4 class="ui header">Cadastro de Ferramentas</h4>
    </div>
	<form action="http://localhost/ferramenta_bd1-master/index.php/MainPage/cadastro_maquinas/<?php if(isset($filial)) echo $filial; ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data" class="ui form 1">
    <div class="ui form inverted segment">
      <div class="two fields">
        <div class="field">
          <label>Modelo</label>
          <input placeholder="Modelo" name="modelo" id="modelo" type="text">
        </div>
        <div class="field">
          <label>Fabricante</label>
          <input placeholder="Fabricante" name="fabricante" id="fabricante" type="text">
        </div>
      </div>
	  ...
	  <div class="two fields">
		<div class="field">
          ...
          <input placeholder="Numero de Série" name="numserie" id="numserie" type="text">
        </div>
		<div class="field">
      ...
      <input type="hidden" name="filial" value="<?php if(isset($filial)) echo $filial; ?>">
	  <div class="field">
	  <label>Imagem</label>
