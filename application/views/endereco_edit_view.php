...
<body>
  ...
  <main>
    ...
    <div class="ui segment">
      <h4 class="ui header">Edição de Endereço</h4>
    </div>
	<form action="http://localhost/ferramenta_bd1-master/index.php/Edicao/Endereco/<?php if(isset($dados)) echo $dados["id"]; ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data" class="ui form 1">
