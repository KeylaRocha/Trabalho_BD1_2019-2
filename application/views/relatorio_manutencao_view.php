...
<body>
  ...
  <main>
	...
	<div class="ui segments">
      <div class="ui center aligned segment">
        <h2>Manutenções Presentes e Passadas</h2>
      </div>
    </div>
	<div class="ui large container">
	<div class="ui top attached inverted header">Manutenções</div>
	...
	<?php if(isset($manuts)){
			...
			foreach($manuts as $r){
				echo "<tr>";
				echo "<td>".$r[0]->getIdManutencao()."</td>";
				echo "<td>".$r[0]->getIdMaquina()."</td>";
				echo "<td>".$r[1]->getModelo()."</td>";
				echo "<td>".$r[1]->getNumeroSerie()."</td>";
				echo "<td>".$r[1]->getFabricante()."</td>";
				echo "<td>".$r[2]."</td>";
				echo "<td>".$r[3]."</td>";
				echo "<td>".$r[0]->getDataEntrada()."</td>";
				echo "<td>".$r[0]->getDataSaida()."</td>";
				echo "<td>".$r[0]->getCusto()."</td>";
				echo '<td>
  ...
  <div class="content">
    <p>Você confirma que deseja deletar a Manutenção ?</p>
	</div>
	<div class="actions">
